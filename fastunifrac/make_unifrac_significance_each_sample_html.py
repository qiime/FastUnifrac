...
ROW_TABLE_HTML = ('<tr><td class="row_header">%s</td>'
                  '<td class="normal" bgcolor="%s" nowrap>%s</td></tr>')

TABLE_HTML = ('<table cellpadding=2 cellspacing=2 border=1><tr> '
              '<td colspan=2 class="header">%s</td></tr><tr>'
              '<td class="header">Sample</td>'
              '<td class="header" nowrap>P Value</td>'
              '</tr>%s</table><br>')

ROW_TABLE_LEGEND_HTML = ('<tr><td class="normal" bgcolor="%s" '
                         'nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                         '&nbsp;</td><td class="row_header">%s</td></tr>')

TABLE_LEGEND_HTML = ('<table cellpadding=2 cellspacing=2 border=1><tr> '
                     '<td colspan=2 class="header">Color description</td>'
                     '</tr>%s</table><br>')
...
PAGE_HTML = ('<html><head><style type="text/css">'
             ...
             '<div class="container"><div class="float_left">%s</div>'
             '<div class="float_left">%s</div>'
             '<div class="float_left">%s</div></div></body></html>')
