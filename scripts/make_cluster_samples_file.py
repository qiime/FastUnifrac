...
script_info = {}
script_info['brief_description'] = """Generates an html file with an ascii\
 representation of a tree where de SampleIDs are interactive."""
script_info['script_description'] = """Takes a file with a tree in newick\
 format and outputs a html file with an ascii representation of the tree and\
 the SampleIDs are interactive, showing the description provided in the\
 mapping file."""
