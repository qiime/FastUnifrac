...
script_info = {}
script_info[
    'brief_description'] = """Convert a QIIME OTU table to a UniFrac sample mapping file"""
script_info[
    'script_description'] = """This script allows users who have picked OTUs in QIIME to convert it to a sample mapping (environment) file for use with the Unifrac web interface."""

script_info['script_usage'] = []

script_info['script_usage'].append(("""Example:""", """Convert a biom-formatted OTU table to a unifrac sample mapping (environment) file: """,
                                    """%prog -i otu_table.biom -o otu_table.sample_mapping.txt"""))
